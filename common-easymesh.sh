...
#   branch devel, pin 2026-08-06 -> b5d0bf696 (RDK+TEMP cleanup, phase-1 one-of-N fixes)
#
...
easymesh_setup_iopsys_feed() {
	...
	( cd "${EASYMESH_SHARED}/iopsys-feed" && git reset --hard b5d0bf696 && git clean -fd ) 2>/dev/null || \
