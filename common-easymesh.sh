...
#   branch devel, pin 2026-08-07 -> c4f7d4bba (+ libwifi 942: mlo_capable for 4addr STA-MLD)
#
...
easymesh_setup_iopsys_feed() {
	...
	( cd "${EASYMESH_SHARED}/iopsys-feed" && git reset --hard c4f7d4bba && git clean -fd ) 2>/dev/null || \
