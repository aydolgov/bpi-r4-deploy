...
#   branch devel, pin 2026-08-06 -> b5d0bf696 (+ dead-walker removal, truthful comments)
#
...
easymesh_setup_iopsys_feed() {
	...
	( cd "${EASYMESH_SHARED}/iopsys-feed" && git reset --hard 6826887e5 && git clean -fd ) 2>/dev/null || \
