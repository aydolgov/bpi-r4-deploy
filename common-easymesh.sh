...
#   branch devel, pin 2026-08-07 -> ac76e0035 (+ libwifi 942: mlo_capable for 4addr STA-MLD)
#
...
easymesh_setup_iopsys_feed() {
	...
	( cd "${EASYMESH_SHARED}/iopsys-feed" && git reset --hard ac76e0035 && git clean -fd ) 2>/dev/null || \
