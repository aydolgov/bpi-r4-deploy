...
#   branch devel, pin 2026-08-06 -> b5d0bf696 (+ 9999991 ageout, 9999992 neighbor view)
#
...
easymesh_setup_iopsys_feed() {
	...
	( cd "${EASYMESH_SHARED}/iopsys-feed" && git reset --hard 0658180a0 && git clean -fd ) 2>/dev/null || \
